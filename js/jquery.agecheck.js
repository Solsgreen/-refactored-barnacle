...
(function ($){
    ...
    $.ageCheck = function(options) {
        ...
        var settings = $.extend({
            minAge : 21,
            redirectTo : '',
            redirectOnFail : 'https://www.google.com/search?q=frogs&biw=1280&bih=703&source=lnms&tbm=isch&sa=X&ved=0ahUKEwiMkrjp95nRAhVCWSwKHWx_DFAQ_AUIBigB#tbm=isch&q=cute+frogs',
            title : 'Age Verification',
            copy : 'Must be 21 years old to proceed. Please enter your birthdate:'
        }, options);
